...
import type {
  SiteActivityWorkExpenditureFormData,
  SiteActivityWorkExpenditure,
} from './schema'
...
const EXPENDITURE_ENDPOINTS = {
  ...
  BY_SITE: (siteId: number) =>
    `/api/site-activity-work-expenditures/site/${siteId}`,
  BY_ACTIVITY_WORK: (activityWorkId: number) =>
    `/api/site-activity-work-expenditures/activity-work/${activityWorkId}`,
...
export const siteActivityWorkExpenditureApi = {
    ...
    return useQuery({
      ...
      queryFn: async () => {
        const response = await api.get<
          ApiResponse<BackendPageResponse<SiteActivityWorkExpenditure>>
  ...
  useGetByActivityWorkId: (
    ...
    return useQuery({
      queryKey: [
        'site-activity-work-expenditures',
        'activity-work',
        activityWorkId,
        params,
      ],
  ...
  useGetById: (id: number) => {
    return useQuery({
      ...
      queryFn: async () => {
        const response = await api.get<
          ApiResponse<SiteActivityWorkExpenditure>
    ...
    return useMutation({
      ...
      onSuccess: () => {
        queryClient.invalidateQueries({
          queryKey: ['site-activity-work-expenditures'],
        })
  ...
  useUpdate: () => {
    ...
    return useMutation({
      mutationFn: async ({
        ...
        id: number
        data: SiteActivityWorkExpenditureFormData
      }) => {
