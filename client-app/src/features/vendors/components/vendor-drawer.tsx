...
export const VendorDrawer = () => {
  ...
  const { data: vendorTypes = [], isLoading: loadingVendorTypes } =
    vendorTypesApi.useSearch(vendorTypeSearch)
  ...
  const displayVendorTypes = (() => {
    ...
    const selected = allVendorTypes.find(
      (t) => t.id === selectedVendor.vendorTypeId
    )
  ...
  const displayPersonDetails = (() => {
    ...
    const selected = allPersonDetails.find(
      (p) => p.id === selectedVendor.vendorDetailsId
    )
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Popover
                    open={vendorTypeOpen}
                    onOpenChange={setVendorTypeOpen}
                  >
                    <PopoverTrigger asChild>
                      <FormControl>
                        ...
                        >
                          {field.value
                            ? displayVendorTypes.find(
                                (t) => t.id === field.value
                              )?.typeName || 'Select vendor type'
                            : 'Select vendor type'}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Unique code (1-10 uppercase letters, numbers, hyphens,
                    underscores)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
