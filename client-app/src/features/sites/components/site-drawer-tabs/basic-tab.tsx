                      ...
                      >
                        {field.value
                          ? personDetails.find((p) => p.id === field.value)
                            ? personDetails.find((p) => p.id === field.value)?.fullName || `${personDetails.find((p) => p.id === field.value)?.firstName || ''} ${personDetails.find((p) => p.id === field.value)?.lastName || ''}`.trim() || "Unknown"
                            : "Select contact"
                          : "Select contact"}
                        <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                      </Button>
