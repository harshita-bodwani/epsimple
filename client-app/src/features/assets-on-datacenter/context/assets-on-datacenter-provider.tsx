...
const AssetsOnDatacenterContext = createContext<
  AssetsOnDatacenterContextType | undefined
>(undefined)

export function AssetsOnDatacenterProvider({
  children,
}: AssetsOnDatacenterProviderProps) {
  const [selectedPlacement, setSelectedPlacement] =
    useState<AssetsOnDatacenter | null>(null)
...
export function useAssetsOnDatacenter() {
  ...
  if (!context) {
    throw new Error(
      'useAssetsOnDatacenter must be used within AssetsOnDatacenterProvider'
    )
  }
  return context
}
