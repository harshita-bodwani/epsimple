...
export const expendituresInvoiceApi = {
  create: async (
    data: ExpendituresInvoiceFormData
  ): Promise<ApiResponse<ExpendituresInvoice>> => {
    const response = await api.post<ApiResponse<ExpendituresInvoice>>(
      BASE_URL,
      data
    )
  ...
  getAll: async (
    ...
    const response = await api.get<
      ApiResponse<BackendPageResponse<ExpendituresInvoice>>
    >(BASE_URL, {
  ...
  update: async (
    ...
    const response = await api.put<ApiResponse<ExpendituresInvoice>>(
      `${BASE_URL}/${id}`,
      data
    )
    return response.data
