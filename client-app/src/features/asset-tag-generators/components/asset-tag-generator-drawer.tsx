...
import {
  assetTagCodeGeneratorFormSchema,
  type AssetTagCodeGeneratorFormData,
} from '../api/schema'
  ...
  return (
    <Sheet open={isDrawerOpen} onOpenChange={handleClose}>
      <SheetContent className='flex flex-col sm:max-w-2xl'>
        <SheetHeader>
          <SheetTitle>
            {editingGenerator ? 'Edit' : 'Create'} Asset Tag Generator
          </SheetTitle>
          <SheetDescription>
            {editingGenerator
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className='flex-1'>
                    ...
                    <Popover
                      open={assetCategoryOpen}
                      onOpenChange={setAssetCategoryOpen}
                    >
