...
export const assetTagCodeGeneratorFormSchema = z.object({
  ...
  maxSeqDigit: z
    .number()
    .min(1, 'Max sequence digit must be at least 1')
    .max(10, 'Max sequence digit cannot exceed 10')
    .optional()
    .or(z.literal(5)),
  runningSeq: z
    .number()
    .min(1, 'Running sequence must be at least 1')
    .optional()
    .or(z.literal(1)),
})

export type AssetTagCodeGeneratorFormData = z.infer<
  typeof assetTagCodeGeneratorFormSchema
>
