...
export const costTypesApi = {
    ...
    return useQuery({
      ...
      queryFn: async () => {
        const response = await api.get<
          ApiResponse<BackendPageResponse<CostType>>
  ...
  useGetList: () => {
    return useQuery({
      ...
      queryFn: async () => {
        const response = await api.get<ApiResponse<CostType[]>>(
          COST_TYPE_ENDPOINTS.LIST
        )
  ...
  useCreate: () => {
    ...
    return useMutation({
      mutationFn: async (data: CostTypeFormData) => {
        const response = await api.post<ApiResponse<CostType>>(
          COST_TYPE_ENDPOINTS.BASE,
          data
        )
        return response.data.data
  ...
  useUpdate: () => {
    ...
    return useMutation({
      mutationFn: async ({
        ...
        id: number
        data: CostTypeFormData
      }) => {
        const response = await api.put<ApiResponse<CostType>>(
          COST_TYPE_ENDPOINTS.BY_ID(id),
          data
        )
        return response.data.data
