...
import {
  siteCategoryFormSchema,
  type SiteCategoryFormData,
} from '../api/schema'
...
export function SiteCategoryDrawer() {
  const { isDrawerOpen, setIsDrawerOpen, editingCategory, setEditingCategory } =
    ...
    <Sheet open={isDrawerOpen} onOpenChange={handleClose}>
      <SheetContent className='flex flex-col'>
        ...
        <SheetFooter className='mt-4 gap-2 px-4 sm:space-x-0'>
          ...
          <Button type='submit' form='site-category-form' disabled={isLoading}>
            {isLoading ? (
              <>
