...
import {
  useCreateCostItem,
  useUpdateCostItem,
} from '@/features/cost-items/api/cost-items-api'
...
export const CostItemDrawer = () => {
  ...
  const { data: costTypes = [], isLoading: costTypesLoading } =
    costTypesApi.useSearch(costTypeSearch)
  ...
  const displayCostTypes = (() => {
    ...
    const selectedType = allCostTypes.find(
      (t) => t.id === editingCostItem.costTypeId
    )
                  ...
                  <Popover open={costTypeOpen} onOpenChange={setCostTypeOpen}>
                    <PopoverTrigger asChild>
                      <FormControl>
                        ...
                        >
                          {field.value
                            ? displayCostTypes.find((t) => t.id === field.value)
                                ?.typeName || 'Select cost type'
                            : 'Select cost type'}
