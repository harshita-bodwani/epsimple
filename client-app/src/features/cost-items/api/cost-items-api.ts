  ...
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.get<
        ApiResponse<BackendPageResponse<CostItem>>
...
export const useCostItemsList = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.get<ApiResponse<CostItem[]>>(
        COST_ITEM_ENDPOINTS.LIST
      )
...
export const useCreateCostItem = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const errorMessage =
        error?.response?.data?.message || 'Failed to create cost item'
...
export const useUpdateCostItem = () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const response = await api.put<ApiResponse<CostItem>>(
        COST_ITEM_ENDPOINTS.BY_ID(id),
        data
      )
      return response.data.data
    ...
    onError: (error: any) => {
      const errorMessage =
        error?.response?.data?.message || 'Failed to update cost item'
      toast.error(errorMessage)
    },
  })
}
...
export const useDeleteCostItem = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const errorMessage =
        error?.response?.data?.message || 'Failed to delete cost item'
      toast.error(errorMessage)
    },
  })
}
