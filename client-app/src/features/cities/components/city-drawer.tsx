...
export function CityDrawer() {
  const { isDrawerOpen, setIsDrawerOpen, editingCity, setEditingCity } =
    useCityContext()
    ...
    <Sheet open={isDrawerOpen} onOpenChange={handleClose}>
      <SheetContent className='flex flex-col'>
        <SheetHeader className='text-start'>
          <SheetTitle>{editingCity ? 'Update' : 'Create'} City</SheetTitle>
          <SheetDescription>
            {editingCity
                  ...
                  <Popover open={stateOpen} onOpenChange={setStateOpen}>
                    <PopoverTrigger asChild>
                      <FormControl>
                        ...
                        >
                          {field.value
                            ? displayStates.find((s) => s.id === field.value)
