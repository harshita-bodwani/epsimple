...
export const assetsOnSiteApi = {
    ...
    return useQuery({
      ...
      queryFn: async () => {
        const response = await api.get<
          ApiResponse<BackendPageResponse<AssetsOnSite>>
  ...
  useCreate: () => {
    ...
    return useMutation({
      ...
      onError: (error: any) => {
        toast.error(
          error.response?.data?.message || 'Failed to place asset on site'
        )
      },
    })
  },
  ...
  useUpdate: () => {
    ...
    return useMutation({
      ...
      onError: (error: any) => {
        toast.error(
          error.response?.data?.message || 'Failed to update asset on site'
        )
      },
    })
  },
  ...
  useDelete: () => {
    ...
    return useMutation({
      ...
      onError: (error: any) => {
        toast.error(
          error.response?.data?.message || 'Failed to remove asset from site'
        )
      },
    })
  },
