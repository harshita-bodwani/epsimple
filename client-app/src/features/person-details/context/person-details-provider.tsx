...
const PersonDetailsContext = createContext<
  PersonDetailsContextType | undefined
>(undefined)

export function PersonDetailsProvider({
  children,
}: {
  ...
  const [editingPersonDetails, setEditingPersonDetails] =
    useState<PersonDetails | null>(null)
  const [deletingPersonDetailsId, setDeletingPersonDetailsId] = useState<
    number | null
  >(null)
