    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='max-w-2xl'>
        <DialogHeader>
          ...
          <DialogDescription>
            Upload multiple {config.entityName.toLowerCase()}s at once using an
            Excel file
          </DialogDescription>
        </DialogHeader>
          ...
          {progress && (
            <div className='space-y-3'>
              ...
              <div className='grid grid-cols-4 gap-4 text-sm'>
                ...
                <div className='rounded bg-yellow-50 p-2 text-center dark:bg-yellow-950'>
              ...
              {progress.errors && progress.errors.length > 0 && (
                <div className='space-y-2'>
                  {(() => {
                    ...
                    const displayErrors = progress.errors.filter(
                      (error) => error.errorType !== 'DUPLICATE'
                    )
                          ...
                          <Alert variant='destructive'>
                            ...
                            <AlertDescription>
                              <div className='mb-2 font-medium'>
                                {displayErrors.length} validation error(s) found
                                - Full error report downloaded automatically
                              </div>
                              <ScrollArea className='bg-background h-32 w-full rounded border p-2'>
                                <div className='space-y-2'>
